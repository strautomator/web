    ...
    <v-layout column>
        <v-container fluid>
            <h1>
                ...
                <v-btn elevation="1" v-if="!needsProRecipes" class="float-right mt-3 ml-4 text-h6 font-weight-bold" color="primary" to="/automations/edit" title="Create a new automation" fab x-small rounded nuxt>+</v-btn>
