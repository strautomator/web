        ...
        <v-container fluid>
            ...
            <v-card class="mt-5" v-if="user" outlined>
                <v-card-text>
                    ...
                    <div id="calendar-events-map"></div>
                    <div v-if="!loading">
...
export default {
        ...
        try {
            ...
            if (typeof window !== "undefined") {
                if (!Object.prototype.hasOwnProperty.call(window, "google")) {
                    ...
                    mapScript.onload = this.loadMap()
                    mapScript.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyC0cBXUmFBGn_HNlH06F2LM_WG2YWZGKe0&libraries=geometry"
                    mapScript.onerror = (ex) => this.$webError("CalendarMap.fetch", ex)
            ...
            this.$webError("CalendarMap.loadEvents", ex)
        }
    },
    methods: {
        async loadMap(fromCache) {
            try {
                this.map = new google.maps.Map(document.getElementById("calendar-events-map"))
                this.loading = false
    ...
    <div class="mt-1"><a href="https://www.strava.com/clubs/${e.club.id}/group_events/${e.id}">More info...</a></div>
                ...
                this.$webError("CalendarMap.loadMap", ex)
            } finally {
                this.loading = false
            }
        },
        ...
        mapDrawRoutes() {
            for (let e of this.events) {
                ...
                try {
                    ...
                    console.error("CalendarMap.mapBindGpx", e.id, "Failed to draw route", ex)
                }
            }
        },
